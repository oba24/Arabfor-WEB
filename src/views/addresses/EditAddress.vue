...
export default {
    ...
    methods: {
        ...
        getDataToEdit() {
            ...
            this.$axios({
                method: "GET",
                url: `client/address/${this.id}`,
            })
                .then((res) => {
                    // START:: SET DATA
                    this.data.address = res.data.data.address;
                    this.data.addressType = res.data.data.name;
                    this.data.lat = res.data.data.lat;
                    this.data.lng = res.data.data.lng;
                    // END:: SET DATA
                })
                .catch((error) => {
